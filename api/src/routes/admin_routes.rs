...
use super::{
    auth_routes, blog_routes, dashboard_routes, faq_routes, newsletter_routes, notification_routes,
    property_routes, service_routes, settings_routes, testimonial_routes, upload_routes,
};
